...
<head>
    ...
    <meta name="keywords" content="用户权限管理">
...
<script src="${request.contextPath}/webapp/static/manage/js/admin/userRole.js"></script>
...
<script>
    ...
    $(function () {
        ...
        userRole.contextPath = "${request.contextPath}";
        userRole.init(menuId, type);
        userRole.resize();
    });
</script>
</body>
