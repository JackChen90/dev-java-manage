...
<head>
    ...
    <meta name="keywords" content="角色信息管理">
...
<script src="${request.contextPath}/webapp/static/manage/js/admin/roleInfo.js"></script>
...
<script>
    ...
    $(function () {
        ...
        role.contextPath = "${request.contextPath}";
        role.init(menuId, type);
        role.resize();
    });
</script>
