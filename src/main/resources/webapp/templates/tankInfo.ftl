...
<head>
    ...
    <title>管理-储罐信息管理</title>
    <meta name="keywords" content="储罐信息管理">
    <meta name="description" content="储罐信息管理">
...
<script src="${request.contextPath}/webapp/static/manage/js/tankInfo.js"></script>
...
<script>
    ...
    $(function () {
        ...
        tank.contextPath = "${request.contextPath}";
        tank.init(menuId, type);
        tank.resize();
    });
</script>
